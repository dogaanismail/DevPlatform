using DevPlatform.LinqToDB.Include.Accessors;
...
namespace DevPlatform.LinqToDB.Include.Builders
{
    public static class PropertyQueryBuilder
    {
            ...
            where TChild : class
        {
            ...
            var resultingQuery = Internals.CreateExpressionQueryInstance<TChild>(db, outerWhere);
