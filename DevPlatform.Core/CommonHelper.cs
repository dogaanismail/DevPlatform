using DevPlatform.Common.Cryptography;
...
namespace DevPlatform.Core
{
    ...
    public partial class CommonHelper
    {
        ...
        //    if (pi == null)
        //        //throw new Exception("No property '{0}' found on the instance of type '{1}'.", propertyName);
        //    if (!pi.CanWrite)
        ...
        /// </summary>
        public static IDevPlatformFileProvider DefaultFileProvider { get; set; }
