...
namespace DevPlatform.Core.Infrastructure
{
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <summary>Gets or sets whether DevPlatform should iterate assemblies in the app domain when loading Nop types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that DevPlatform assemblies aren't investigated (e.g. by not including something like "^Nop|..." you may break core functionality.</remarks>
