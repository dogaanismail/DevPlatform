...
{
    /// <summary>
    /// A class that finds types needed by devPlatform by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        protected IDevPlatformFileProvider _fileProvider;

        #endregion

        #region Ctor

        public AppDomainTypeFinder(IDevPlatformFileProvider fileProvider = null)
        {
        ...
        /// <summary>Gets or sets whether DevPlatform should iterate assemblies in the app domain when loading devPlatform types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that DevPlatform assemblies aren't investigated (e.g. by not including something like "^devPlatform|..." you may break core functionality.</remarks>
