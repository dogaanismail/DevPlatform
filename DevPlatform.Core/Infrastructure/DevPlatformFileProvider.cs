...
namespace DevPlatform.Core.Infrastructure
{
    ...
    /// </summary>
    public class DevPlatformFileProvider : PhysicalFileProvider, IDevPlatformFileProvider
    {
        /// <summary>
        /// Initializes a new instance of a DevPlatformFileProvider
        /// </summary>
        /// <param name="webHostEnvironment">Hosting environment</param>
        public DevPlatformFileProvider(IWebHostEnvironment webHostEnvironment)
