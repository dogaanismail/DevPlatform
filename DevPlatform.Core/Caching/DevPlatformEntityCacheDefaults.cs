...
namespace DevPlatform.Core.Caching
{
    ...
    public static partial class DevPlatformEntityCacheDefaults<TEntity> where TEntity : BaseEntity
    {
        ...
        /// {0} : entity id
        /// </remarks>
        public static CacheKey ByIdCacheKey => new CacheKey($"DevPlatform.{EntityTypeName}.byid.{{0}}", ByIdPrefix, Prefix);
        ...
        /// {0} : entity ids
        /// </remarks>
        public static CacheKey ByIdsCacheKey => new CacheKey($"DevPlatform.{EntityTypeName}.byids.{{0}}", ByIdsPrefix, Prefix);

        /// <summary>
        /// Gets a key for caching all entities
        /// </summary>
        public static CacheKey AllCacheKey => new CacheKey($"DevPlatform.{EntityTypeName}.all.", AllPrefix, Prefix);
