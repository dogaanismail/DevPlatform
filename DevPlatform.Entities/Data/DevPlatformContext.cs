...
namespace DevPlatform.Entities.Data
{
    public class DevPlatformContext : IdentityDbContext<AppUser, IdentityRole<int>, int>
    {
        public DevPlatformContext(DbContextOptions<DevPlatformContext> options) : base(options)
        {
