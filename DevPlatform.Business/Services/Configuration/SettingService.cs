...
namespace DevPlatform.Business.Services.Configuration
{
    /// <summary>
    /// Setting service
    /// </summary>
    public partial class SettingService : ISettingService
    {
        ...
        {
            return await _staticCacheManager.GetAsync(DevPlatformConfigurationDefaults.SettingsAllAsDictionaryCacheKey, async () =>
            {
        ...
        {
            await _staticCacheManager.RemoveByPrefixAsync(DevPlatformEntityCacheDefaults<Setting>.Prefix);
        }
