...
using AlbumImage = DevPlatform.Core.Domain.Album.AlbumImage;

namespace DevPlatform.Business.Services.Album
{
    /// <summary>
    /// Album service
    /// </summary>
    ...
    {
        #region Fields
        private readonly IRepository<AlbumEntity> _albumRepository;
        ...
        #region Ctor
        public AlbumService(IRepository<AlbumEntity> albumRepository,
        ...
        /// <returns></returns>
        public virtual async Task<ResultModel> CreateAsync(AlbumEntity album)
        {
            if (album == null)
        ...
        /// <returns></returns>
        public virtual async Task<ResultModel> CreateAsync(List<AlbumEntity> albums)
        {
            if (albums == null)
        ...
        /// </summary>
        /// <param name="album"></param>
        public virtual async Task DeleteAsync(AlbumEntity album)
        {
            if (album == null)
                throw new ArgumentNullException(nameof(album));
        ...
        /// <returns></returns>
        public virtual async Task<AlbumEntity> GetByIdAsync(int albumId)
        {
            if (albumId == 0)
                return null;
        ...
        public virtual async Task<List<AlbumEntity>> GetUserAlbumsByUserIdAsync(int userId)
        {
            throw new NotImplementedException();
        }
        ...
        /// </summary>
        /// <param name="album"></param>
        public virtual async Task UpdateAsync(AlbumEntity album)
        {
            if (album == null)
                throw new ArgumentNullException(nameof(album));
