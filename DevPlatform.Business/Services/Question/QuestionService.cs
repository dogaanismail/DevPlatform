...
namespace DevPlatform.Business.Services.Question
{
    /// <summary>
    ...
    public partial class QuestionService : ServiceExecute, IQuestionService
    {
        ...
        public QuestionService(IRepository<QuestionEntity> questionRepository,
        ...
        /// <returns></returns>
        public virtual async Task<ResultModel> CreateAsync(QuestionEntity question)
        {
            if (question == null)
        ...
        /// <returns></returns>
        public virtual async Task<ResultModel> CreateAsync(List<QuestionEntity> questions)
        {
            if (questions == null)
        ...
        /// </summary>
        /// <param name="question"></param>
        public virtual async Task DeleteAsync(QuestionEntity question)
        {
            if (question == null)
                throw new ArgumentNullException(nameof(question));
        ...
        /// </summary>
        /// <param name="question"></param>
        public virtual async Task UpdateAsync(QuestionEntity question)
        {
            if (question == null)
                throw new ArgumentNullException(nameof(question));
        ...
        /// <returns></returns>
        public virtual async Task<QuestionEntity> GetByIdAsync(int questionId)
        {
            if (questionId == 0)
                return null;

            var cacheKey = _staticCacheManager.PrepareKeyForDefaultCache(DevPlatformEntityCacheDefaults<QuestionEntity>.ByIdCacheKey, questionId);
        ...
        {
            var cacheKey = _staticCacheManager.PrepareKeyForDefaultCache(DevPlatformEntityCacheDefaults<QuestionEntity>.ByIdCacheKey, id);
