...
namespace DevPlatform.Business.Interfaces.Question
{
    ...
    public partial interface IQuestionService
    {
        ...
        Task<ResultModel> CreateAsync(QuestionEntity question);

        /// <summary>
        /// Inserts questions by using bulk
        /// </summary>
        /// <param name="question"></param>
        Task<ResultModel> CreateAsync(List<QuestionEntity> questions);
        ...
        /// </summary>
        /// <param name="question"></param>
        Task DeleteAsync(QuestionEntity question);
        ...
        /// <returns></returns>
        Task<QuestionEntity> GetByIdAsync(int questionId);
