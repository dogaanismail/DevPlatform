...
namespace DevPlatform.Business.Common.Caching
{
    /// <summary>
        ...
        where TEntity : BaseEntity
    {
        ...
        {
            await RemoveByPrefixAsync(DevPlatformEntityCacheDefaults<TEntity>.ByIdsPrefix);
            await RemoveByPrefixAsync(DevPlatformEntityCacheDefaults<TEntity>.AllPrefix);

            if (entityEventType != EntityEventType.Insert)
                await RemoveAsync(DevPlatformEntityCacheDefaults<TEntity>.ByIdCacheKey, entity);
